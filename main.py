...
@bot.command(brief='Leaderboard of :3', description='Leaderboard of :3 usages', help='Displays leaderboard of :3 usages')
...
@bot.command(brief='Shows your :3 count', description='Shows your :3 count', help='Shows your :3 count')
async def count(ctx):
...
@bot.command(brief='Get Leaderboard of Average Wordle Scores', description='Get Leaderboard of Average Wordle Scores, Best SCore feature coming soon tm', help='Displays leaderboard of average wordle scores')
